...
class ControllerSpdRoute extends Controller
{
	...
	public function convocatorias($id_carrera){
		if($id_carrera==0)
			$convocatoria=DB::table('view_convocatoria')->get();
		else
			$convocatoria=DB::table('view_convocatoria')->where('id_carrera',$id_carrera)->get();
	...
	#MODULO COMICION
	public function login_comicion(){
    	
    	return view('admin.login_comicion');
